...
package com.manas.daopattern.application;

import java.util.List;
import java.util.Optional;

import com.manas.daopattern.config.JpaEntityManagerFactory;
import com.manas.daopattern.daos.Dao;
import com.manas.daopattern.daos.JpaUserDao;
import com.manas.daopattern.entities.User;

public class UserApplication {
    
    
    public static void main(String[] args) {
        User user1 = getUser(9);
        System.out.println("user by id: "+user1);
